...
module tb_top_rx;
    ...
    initial begin
        ...
        uart_send_byte("1"); uart_send_byte(8'h20);
        uart_send_byte("2"); uart_send_byte(8'h20);
        uart_send_byte("3"); uart_send_byte(8'h20);
        uart_send_byte("4"); uart_send_byte(8'h20);
        uart_send_byte("5"); uart_send_byte(8'h20);
        uart_send_byte("6");
        ...
        uart_send_byte("4"); uart_send_byte(8'h20);
        uart_send_byte("5"); uart_send_byte(8'h20);
        uart_send_byte("6"); uart_send_byte(8'h20);
        uart_send_byte("4"); uart_send_byte(8'h20);
        uart_send_byte("5"); uart_send_byte(8'h20);
        uart_send_byte("6");
